...
const DEVICE_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI4NzZmMzU0Zi00MjE5LTRhMWUtOGFlNi00MTJiMjVlNWJjMjEiLCJkZXZpY2VJZCI6IjEyZTI0MjQ1LWMyMzMtNDhlYS04NDI0LWIwNzFkZjY1OTcxMiIsImlhdCI6MTc3OTk5ODI2OSwiZXhwIjoxODExNTM0MjY5fQ.KFADt00nH1Q2W-m3n4JFq-e6AcJCz6QwGZfXbyZSi60';
const DEVICE_ID = (() => {
  try {
...
async function sendHeartbeat(status, error) {
  try {
    await fetch(`${API_URL}/extension/heartbeat`, {
      ...
      body: JSON.stringify({ status, error: error || null, version: EXT_VERSION }),
    });
  } catch (err) {}
}
