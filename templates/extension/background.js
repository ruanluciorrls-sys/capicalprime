const FORCED_VPS_API_URL = 'http://177.153.202.47:3001/api/v1';
const FORCED_VPS_WS_URL = 'http://177.153.202.47:3001';
const API_URL = String('{{API_URL}}' || '').includes('localhost') ? FORCED_VPS_API_URL : '{{API_URL}}';
const WS_URL = String('{{WS_URL}}' || '').includes('localhost') ? FORCED_VPS_WS_URL : '{{WS_URL}}';
const EXT_VERSION = '{{VERSION}}';
